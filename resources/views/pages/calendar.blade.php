...
@if ( DB::table('users')->where('id', Auth::user()->id)->value('calendar') != null)
  <div class="calendar">
...
@if (DB::table('users')->where('id', Auth::user()->id)->value('calendar') == null)
  <div class="instructions">
    ...
    <ol>
      ...
      <li>Go to the Personal Settings Page at <a href="http://housemates.fun/pages/settingsPages/personalSettings">housemates.fun/settingsPages/personalSettings.</a></li>
